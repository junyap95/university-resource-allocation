...
test("Booking Page Form Filling Test", async ({ page }) => {
  ...
  await page
    .getByPlaceholder("ex. john.smith@gmail.com")
  ...
  await expect(page.getByTestId("form-confirmation-First Name")).toContainText(
    "John"
  );
